...
# first = pd.read_csv('results/first-qwen-2.5-7b-old.csv')
first = pd.read_csv('/home/fril/mas/results/first-mistral-0.2-7b-1.csv')
...
second = pd.read_csv('/home/fril/mas/results/first-mistral-0.2-7b-2.csv')
...
if not first.columns.equals(second.columns):
    ...
    combined.to_csv('results/first-mistral-0.2-7b.csv', index=False)
